...
export default async (provider) => {
  const { default: OIDCProvider, errors } = await import('oidc-provider')
  const { defaults } = import('oidc-provider/lib/helpers/defaults.js') // TODO create render err
  const Account = await import('../support/account.js')
